...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angle,BakerStreet,Bank, Barbican,Bayswater, Blackfriars,Bond Street," +
                ...
                "Farringdon,Gloucester Raod, Goodgs Street, Great Portland Street, Green Park").split(",");
        ...
        do {
            ...
            String str = JOptionPane.showInputDialog(frame, "Enter station Name Between " +
                    "A to G ?", "Station Name", JOptionPane.WARNING_MESSAGE);
            String c = "";
            ...
            b = JOptionPane.showInputDialog(frame, "Do you want to try again then please " +
                    "press Y", "Press Y or N", JOptionPane.WARNING_MESSAGE).toLowerCase();
        } while (b.equals("y"));
        System.exit(0);
    }
}
