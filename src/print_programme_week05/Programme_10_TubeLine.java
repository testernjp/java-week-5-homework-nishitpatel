...
public class Programme_10_TubeLine {
    ...
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angel", "Baker Street", "Bank",
                "Barbican", "Bayswater", "Blackfriers", "Bond Street", "Borough", "Cannon Street", "Chancery Lane",
                " Charing Cross", "Covent Garden", "Earl's Court", "Elephant & Castle", "Green Park",
                "High Street Kensington", "Holborn", "Hype Park Corner", "Kings Cross", "Knightsbridge",
                "Lambeth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "Oxford Circus",
                "Paddington", "Piccadilly Circus", "Pimlico", "Queensway", "Regent's Park", "Russel Square",
                "Sloane Square", "South Kensington", "St Pancras", "St. Paul's", "Temple", "Tottenham Court Rd",
                "Tower Gateway", "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East", "Waterloo",
                "Westminster"};
        ...
        for (int i = 0; i < tubeStationZone1.length; i++) {
            if (userTubeStation.equalsIgnoreCase(tubeStationZone1[i])) {
                catchStationNames = tubeStationZone1[i];
            }
        }
        // Logic to find the Line names from the given input from the user
        if (userTubeStation.equalsIgnoreCase(catchStationNames)) {
